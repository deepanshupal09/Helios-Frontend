      ...
      {dropdownOpen && (
            ...
            <li>
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1815_13085)">
                    <path
        ...
        <div className="fixed inset-0 flex w-screen items-center justify-center">
          <DialogPanel className="max-w-lg rounded-lg border-[0.5px] border-stroke  gap-2 px-6 pb-5.5 pt-5.5  bg-white shadow-default dark:border-dark-3 dark:bg-gray-dark ">
            ...
            <Description className="text-dark-5  font-medium mt-2 mb-7">Are you sure you want to logout?</Description>
            <div className="flex gap-2 justify-end">
              <button className="w-full rounded-lg bg-light bg-dark py-3 font-medium text-white hover:bg-primary-dark focus:outline-none" onClick={cancelLogout}>Cancel</button>
              <button className="w-full rounded-lg bg-red-600 py-3 font-medium text-white hover:bg-primary-dark focus:outline-none" onClick={confirmLogout}>Logout</button>
            </div>
          </DialogPanel>
        </div>
      </Dialog>
