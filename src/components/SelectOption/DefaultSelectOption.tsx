...
const DefaultSelectOption = ({ options, selectedOption, setSelectedOption }: {options: string[], selectedOption: string, setSelectedOption: Dispatch<SetStateAction<string>>}) => {
